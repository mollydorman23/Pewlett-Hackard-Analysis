...
WHERE (birth_date BETWEEN '1952-01-01' AND '1955-12-31')
AND (hire_date BETWEEN '1985-01-01' AND '1988-12-31');
-- Make new database with retiring employees
SELECT first_name, last_name
...
-- Join emp_info and salaries tables
SELECT e.emp_no,
    e.first_name,
e.last_name,
    e.gender,
...
-- Skill Drill: Sales Department Retirees
select * 
from dept_info
where dept_name = 'Sales';

-- Skill Drill: Sales + Development Department Retirees
SELECT * 
FROM dept_info
